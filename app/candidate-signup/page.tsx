...
import { useRegisterCandidate } from "../queries/candidates/signup";

const page = () => {
  const { mutate, isPending, isError, isSuccess, error, data } = useRegisterCandidate();
        ...
        <div className="w-[400px] md:w-[500px] bg-white relative overflow-hidden p-6 rounded-xl shadow-md">
          ...
          <form className="w-full mt-3">
            ...
            <button
              ...
              className={`w-full cursor-pointer mt-1.5 rounded-md py-2 px-5 transition-colors duration-500 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-base text-center`}
            >
